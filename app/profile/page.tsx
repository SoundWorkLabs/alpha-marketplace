        ...
        <Box className="mx-10">
            <Flex gap='lg' className="p-5" wrap="wrap">
                <Flex direction='column' gap={20}>
                    <Box>
                        <Avatar size="xl" src={null} alt="Jimii Mutuku" color="red">JM</Avatar>
                    </Box>
                    <Box>
                        {`${publicKey?.toBase58().substring(0, 6) ?? ""} ${publicKey?.toBase58().substring(26, 32) ?? ""}` ?? "Connect Wallet" } {/* // todo: create hook for this */}
                    </Box>
                </Flex>
                    ...
                    <Box>
                        ...
                        >
                            ...
                            <Flex className="py-2 px-3" gap={100} >
                                {
                                    Object.entries(dummyItemValObj).map(([label, value]) => (
